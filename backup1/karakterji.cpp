...
Enemy::Enemy()
{
	enemyRect.w = 25;
	enemyRect.h = 50;
	enemyRect.x = rand() % 1256;
	enemyRect.y = rand() % 671;
}

void Enemy::movement()
{
	// todo: nared random movement enemya
}
...
void Enemy::setEnemyTexture(SDL_Texture* sentTexture)
{
	enemyTexture = sentTexture;
}


void Enemy::destroySDL()
{
